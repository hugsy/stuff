...
__file__      =   "smb-enumallfiles.py"
__desc__      =   "This script will index all browsable files available through SMB shares. The only required input is the SQLite database generated by `unmap`"
